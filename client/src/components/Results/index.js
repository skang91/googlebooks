                                ...
                                <div className="card mb-3" key={result._id}>
                                    <div className="row">
                                        <div className="col-md-2">
                                            <img alt={result.title} className="img-fluid mt-3 ml-3" src={result.image} />
                                        </div>
                                        <div className="col-md-10">
                                            <div className="card-body">
                                                ...
                                                <div>
                                                    <a href={result.link} className="btn btn-primary mt-3 ml-1 mb-3" target="_blank" >View</a>
                                                    <button onClick={() => this.handleSave(result)} className="btn btn-success mt-3 ml-3 mb-3" >
